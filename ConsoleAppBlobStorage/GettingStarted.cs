...
namespace ConsoleAppBlobStorage
{
    public static class GettingStarted
    {
       // const string ImageToUpload = "HelloWorld.png";
        ...
        private const string ContainerPrefix = "sampleblob";
        ...
        private static async Task BasicStorageBlockBlobOperationsAsync()
        {
            ...
            var blobpic = container.GetBlockBlobReference(ImageToUpload);
            blobpic.Metadata.Add("dateuploaded", DateTime.Today.ToString());

            var DateUploaded = blobpic.Metadata.FirstOrDefault(x => x.Key == "dateuploaded").Value;
            Console.WriteLine(DateUploaded.ToString());
